	...
	<div id="sidebar" class="span3">
		...
		<ul id="sideManu" class="nav nav-tabs nav-stacked">
			...
			<ul style="display:none">
				<li><a href="products.html"><i class="icon-chevron-right"></i>Womens Clothing (45)</a></li>
				<li><a href="products.html"><i class="icon-chevron-right"></i>Womens Shoes (8)</a></li>												
				<li><a href="products.html"><i class="icon-chevron-right"></i>Womens Hand Bags (5)</a></li>	
				<li><a href="products.html"><i class="icon-chevron-right"></i>Mens Clothings  (45)</a></li>
